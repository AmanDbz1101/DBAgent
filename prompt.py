...
def qa_agent_prompt(message: str, inventory_data: str) -> str:
...
def upsert_agent_prompt(message: str, inventory_data: str) -> str:
...
quantity → integer or null (required)
...
def delete_agent_prompt(message: str, inventory_data: str) -> str:
...
def get_qa_agent_prompt(message: str, inventory_data: str):
    """Returns a formatted QA agent prompt."""
    return qa_agent_prompt(message, inventory_data)

def get_upsert_agent_prompt(message: str, inventory_data: str):
    """Returns a formatted upsert agent prompt."""
    return upsert_agent_prompt(message, inventory_data)

def get_delete_agent_prompt(message: str, inventory_data: str):
    """Returns a formatted delete agent prompt."""
    return delete_agent_prompt(message, inventory_data)
